  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        />
        <Route
          path="/sell/SellDetail/:sell_offer_id"
          element={<ProtectedRoute component={SellDetail} />}
        />

        <Route
          path="/CreateBuy"
          element={<ProtectedRoute component={CreateBuy} />}
        />
        <Route
          path="/CreateSell"
          element={<ProtectedRoute component={CreateSell} />}
        />
        ...
        <Route
          path="/InputForm"
          element={<ProtectedRoute component={InputForm} />}
        />
        <Route
          path="/EditSellOffer/:sell_offer_id"
          element={<ProtectedRoute component={EditSellOffer} />}
        />
        <Route
          path="/EditBuyOffer/:buyOfferId"
          element={<ProtectedRoute component={EditBuyOffer} />}
        />
