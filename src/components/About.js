      ...
      <div>
       ...
       <div className='images'>
        <img src={require("../images/accenture_logo.jpg").default}  className='img1'/>
         ...
         <div id="description"   >
          <p>
            DDRC (Decentralized Data, Research, and Consulting) is an exchange where professionals and organizations can find each other and pay for high-quality, 
          ...
          <p>
            DDRC is therefore looking to capitalize on this market opportunity. The goal is to take power away from the prestigious research and consulting firms, who have fallen into groupthink in recent years, and put it back into the hands of the individual consultant and researcher. 
...
<p> All of these people have the potential ingredients to be good management consultants. Using the DDRC platform, they can monetize their experience and time into actionable market intelligence. </p>
<p> We believe the market for untapped market intelligence is vast, and that our solution is optimal for realizing it. </p>
 ...
 {/*  <Accordion.Item eventKey="2">
  ...
  <Accordion.Item eventKey="3">
    <Accordion.Header>Who would be ideal consumers of DDRC?</Accordion.Header>
    <Accordion.Body>
...
<p> Those who believe they have specific market intelligence, data, or consulting knowledge or talent can list their offerings <NavLink id="linky" to={`/CreateSell`}> here.</NavLink> Such talent can run the gamut from retired industry personnel, to someone transitioning fields, to former consultants, to someone who has simply been in an area or industry long enough to gather insights that many people would not be aware of. Many people can monetize their access to information, but just haven’t had the platform to realize it! </p>
  ...
  <Accordion.Item eventKey="4">
    ...
    <Accordion.Body>
    <p> All participants who use DDRC are required to first identify and authenticate through LinkedIn. </p>
...
<p> The payment process is done through an escrow process using another member of the NEO community, Nekohit. Sellers can stake a percentage of funds to give comfort to the buyer that they have skin in the game as well. If the buyer is not satisfied, in addition to obtaining a refund, he or she may be able to access a portion of what the seller staked. </p>
  ...
  <Accordion.Item eventKey="5">
    ...
    <Accordion.Body>
    <p> As DDRC is not responsible to enforce the quality or terms of the transaction, it is important that buyers and sellers confirm these terms with each other before entering into the transaction. Using the messaging feature to communicate extensively with the other party beforehand is very important. 
...
-	What are the specific deliverables/ talking points for each milestone we can expect to be delivered for each price point? </p>
  ...
  <Accordion.Item eventKey="7">
    ...
    <Accordion.Body>
    <p>
    Nekohit, like DDRC, was one of the winners of the Frontier Launchpad hackathon in the summer of 2021. 
    Its premise is to create the first and fully decentralized
crowdfunding platform for content creators on the blockchain. 
Like DDRC, it uses NEP (NEO)- based tokens as the currency of exchange. 
We believe the escrow system is the most effective that we’ve seen thus far for decentralized transactions.
How it can work alongside DDRC is as follows: 
</p> <p>
  After the buyer and seller finds their match on DDRC, they begin the process of building trust. 
  First, the buyer and the seller use the DDRC messaging platform to establish contact, 
