...
//const values = {industry, offer_type, offer_details, price, qualifications, user_id, buy_offer_id};
   ...
   const handleSubmit = (e) => {
    e.preventDefault();
    const points = {industry, offer_type, offer_details, target_audience, price, headline, qualifications, user_id, sell_offer_id};
   ...
   const handleSelect2=(e)=>{
     ...
     setValue2(e)
      ...
      <h4 className="result">{value}</h4>
            <div className="formfield">What industry is your data/services for? (i.e. internet, energy, healthcare, etc.): <input type="varchar" id="industry" name="industry" maxLength="50" value={industry} onChange={(e) => setIndustry(e.target.value)} required/></div> <br/>
            ...
            <div className="formfield">Describe your target audience or market: <input type="varchar" name="target_audience" value={target_audience} onChange={(e) => setOffer_details(e.target.value)} required/></div><br/>
                     ...
                     value={rate_type} onChange={(e) => setRate_type(e.target.value)}
                     >
                     ...
                     <div className="formfield">How much are you willing to sell these products or services for? (i.e. $100/hr. for video call, flat rate, etc.): <input type="numeric" name='price' id="price" maxLength="50" value={price} onChange={(e) => setPrice(e.target.value)} required/></div><br/>
            ...
            <div className="formfield">Please provide a headline summary of who you are and what you're offering (Less than 100 words) <input type="varchar" name='headline' maxLength="200" id="headline" value={headline} onChange={(e) => setQualifications(e.target.value)} required/></div><br/>
