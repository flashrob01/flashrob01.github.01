...
//a function as defined above and instantiated below!
    ...
    return (
        <div>
        <nav>
              <Link to="/"><img src={require("../images/homeIcon.png").default} alt="Homepage Icon" className="icon"/></Link>
              <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                ...
                >
                  ...
                  >
                    <li className='fas fa-caret-down' /><img src={require("../images/buy_now_icon.png").default} alt="Buy Icon" className="icon"/>
                    </Link>
                ...
                >
                  ...
                  onClick={closeMobileMenu}
                  >
                    <li className='fas fa-caret-down' /><img src={require("../images/sell_icon.png").default} alt="Sell Icon" className="icon"/>
                    </Link>
              ...
              <div id='about'><Link to="/about"><img src={require("../images/about_us.png").default} alt="About Us" className="icon"/></Link></div>
