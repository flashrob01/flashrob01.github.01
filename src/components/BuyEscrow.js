  ...
  return (
    <div>
      {Object.entries(filteredItems).map(
        ([
          none,
          { price, industry, offer_details, offer_type, qualifications },
        ]) => (
          <div key={buy_offer_id} className="offer" id="offer">
            <h2>
              Please make an escrow payment of ${price} to your DDR account now.
            </h2>
            <p>
              {" "}
              ${price} in NEO will be added to your NEO escrow account. The
              payment will stay in escrow for a period of 24 hours. During that
              time period, you and the seller to arrange to complete the terms
              of your transaction.
            </p>
            <div></div>
            ...
            <p>
              Please be sure that you do not release the escrowed amount until
              after the transaction is performed. If there are any disputes, you
              may click the dispute button. Note that DDR is not responsible to
              enforce the quality or terms of the transaction, so please be sure
              to confirm these with the seller before you decide to enter into
              the transaction.
            </p>
            <h2>
              Once you've made the payment, be sure to click Paid within the
              given time limit. Otherwise, the trade will be automatically
              canceled and the NEO will be returned to your wallet.
            </h2>
            <Link
              to={{
                pathname: `/`,
            ...
            >
              <Button onClick={() => alert("Selecting: ")}>
                {" "}
