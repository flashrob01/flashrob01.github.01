...
const SellIndex = () => {
  const GET_SELL_OFFERS_QUERY = gql`
    query GetSellOffers($sell_offer_id: Int!) @cached {
      ...
      users(
        where: { sell_offers: { sell_offer_id: { _eq: $sell_offer_id } } }
      ) {
        email
        first_name
        picture
 ...
 */
  ...
  return /* visible ==="true"  &&  */ data ? (
    <AuthorizedApolloProvider>
      <div className="grid2">
        <div id="banner_sell">
          <h1 className="h1">Connect with an Expert</h1>
        </div>
          ...
          <CardContainer>
            <CardContent>
              <CardBody>
                ...
                <DetailRow>
                  <div id="viewCount">
                    Industry: {data.sell_offers[0].industry}{" "}
                  </div>
                </DetailRow>
                <DetailRow>
                  <div id="viewCount">
                    Region: {data.sell_offers[0].region}{" "}
                  </div>
                </DetailRow>
                <DetailRow>
                  <div id="viewCount">
                    {" "}
                    Target Audience: {data.sell_offers[0].target_audience}{" "}
                  </div>
                </DetailRow>
                <DetailRow>
                  <div id="viewCount">
                    Languages: {data.sell_offers[0].languages}{" "}
                  </div>{" "}
                </DetailRow>
            ...
            <Tab eventKey="home" title="Details" id="tab1">
              <DetailRow>
                <div id="qualifications">
                  Biography/Qualifications: {data.sell_offers[0].qualifications}{" "}
                </div>
              </DetailRow>
              <DetailRow>
                <div id="offer_details">
                  {" "}
                  Offer Details: {data.sell_offers[0].offer_details}
                </div>
              </DetailRow>
            </Tab>
        ...
        <div className="box_track">
          ...
          <div id="viewCount">
            {" "}
            Offer Type: {data.sell_offers[0].offer_type}{" "}
          </div>
