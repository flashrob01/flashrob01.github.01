...
console.log('here is link', linky);
 ...
 <h2>You selected to purchase:  {data.sell_offers[0].headline} </h2>
    ...
    <p>  in NEO will be added to your NEO escrow account. The payment will stay in escrow for a period of 24 hours. During that time period, you and the seller to arrange to complete the terms of your transaction.
    </p>
    <div></div>
