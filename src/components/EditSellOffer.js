...
/*    addBuy({variables:{industry: input.value, offer_type: input.value, 
    ...
    overlay={renderTooltip}>
                  <input type="string" id="industry" name="industry" defaultValue={data.sell_offers[0].industry} onChange={(e) => setIndustry(e.target.value)} required />
                  </OverlayTrigger>
                </li>
               <li>
               <DropdownButton
      ...
      <h4 className="result">{offer_type}</h4>
                ...
                <li>
                  ...
                  <textarea rows="6"   input class="string" name="offer_details"  defaultValue={data.sell_offers[0].offer_details} onChange={(e) => setOffer_details(e.target.value)} required></textarea>
                </li>  
                 <li>
                  <label for="qualifications">Please provide a short biography describing your relevant qualifications and experience: </label>
                  <OverlayTrigger
    placement="right"
    delay={{ show: 250, hide: 400 }}
    overlay={renderTooltip}>
                  <textarea rows="6"  input class="string"  name='qualifications'  maxLength="400" id="qualifications" defaultValue={data.sell_offers[0].qualifications} onChange={(e) => setQualifications(e.target.value)} placeholder="(i.e. number of years of experience, work with specific companies or industry, knowledge of specific fields or industries, level of education, certifications, achievments, etc.)" required></textarea>
                  </OverlayTrigger>
                </li>
                <li>
                  <label for="target_audience">Describe your target audience or market:</label>
                  <textarea rows="6"  input class="string"  name="target_audience"  defaultValue={data.sell_offers[0].target_audience} onChange={(e) => setTarget_audience(e.target.value)} placeholder="Enter your message here" required></textarea>
                </li>  
                <li>
                  <label for="languages">What languages are you available to communicate in?</label>
                  < input type="varchar" name="languages"  defaultValue={data.sell_offers[0].languages} onChange={(e) => setLanguage(e.target.value)} required />
                </li>
                <li>
                  <label for="region">What is your current location or the location/region of your expertise?:</label>
                  <input type="varchar" name="region"  defaultValue={data.sell_offers[0].region} onChange={(e) => setRegion(e.target.value)} required/>
                </li>
                <li>
                <DropdownButton
        alignRight
        ...
        <h4 className="result">{rate_type}</h4>
                ...
                <li>
                  ...
                  <input class="varchar" name='price' id="price" maxLength="50"  defaultValue={data.sell_offers[0].price} onChange={(e) => setPrice(e.target.value)} placeholder="$" required />
                </li>
                <li>
                  <label for="headline">Please provide a headline summary of who you are and what you're offering (Less than 100 words) </label>
                  <textarea rows="6" input class="string" name='headline' id="headline" maxLength="255" defaultValue={data.sell_offers[0].headline} onChange={(e) => setHeadline(e.target.value)} required></textarea>
                </li>  
                <li>
                <label for="sell_offer_id">Sell Offer ID</label>
                  <input class="varchar" name='sell_offer_id' id='sell_offer_id' value={number} defaultValue={number} readonly="readonly"></input>
                </li>
