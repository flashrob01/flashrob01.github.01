      ...
      <h4 className="result">{offer_type}</h4>
                ...
                <li>
                 ...
                 <li>
                  ...
                  <textarea rows="6"  input class="string"  name='qualifications_sell'  maxLength="400" id="qualifications_sell" value={qualifications} onChange={(e) => setQualifications(e.target.value)} placeholder="(i.e. number of years of experience, work with specific companies or industry, knowledge of specific fields, level of education, certifications, achievments, etc.)" required></textarea>
                </li>
                 <li>
                  <label for="languages">What languages are you looking to communicate in?</label>
                  < input type="varchar" name="languages"  value={languages} placeholder="English" onChange={(e) => setLanguages(e.target.value)} required />
                </li>
                <li>
                <DropdownButton
        alignRight
